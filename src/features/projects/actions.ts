...
function projectValues(formData: FormData) { return { id: formData.get("id"), title: formData.get("title"), slug: formData.get("slug"), summary: formData.get("summary"), contentMarkdown: formData.get("contentMarkdown"), coverImageUrl: formData.get("coverImageUrl"), githubUrl: formData.get("githubUrl"), demoUrl: formData.get("demoUrl"), externalUrl: formData.get("externalUrl"), technologyIds: formData.getAll("technologyIds"), isFeatured: formData.get("isFeatured") === "on", projectStatus: formData.get("projectStatus"), startedOn: formData.get("startedOn"), endedOn: formData.get("endedOn"), seoTitle: formData.get("seoTitle"), seoDescription: formData.get("seoDescription"), canonicalUrl: formData.get("canonicalUrl"), ogImageUrl: formData.get("ogImageUrl") }; }
